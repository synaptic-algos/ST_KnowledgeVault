...
# EPIC-009: Partner Access & Credential Security – Test Plan
...
| Partner E2E | Workspace + delegated access smoke | `tests/epics/epic_009_partner_access/` | product_ops | backlog |

## Execution Cadence
- CI target: `make test-epic_009_partner_access` → runs the buckets marked *planned*.
- Nightly regression: `pytest tests/epics/epic_009_partner_access/` plus module buckets as they come online.
...
- Store logs/artifacts next to sprint execution summaries for audit (e.g., `Sprints/.../artifacts/epic_epic-009_tests/`).

## Open Items
- [ ] Promote bucket owners and scheduling in Sprint 1 backlog.
- [ ] Automate the `make test-epic_009_partner_access` target once first suite lands.
