...
## Test Evidence
- **Parser validation**: ticker/options/spot parsers processed 3,033 option rows and 163,389 spot rows without gaps.
- **Greeks model tests**: 31/31 unit cases passing (delta bounds, gamma > 0, theta/vega signs, put-call parity).
- **Batch verification**: ITM→OTM delta progression, theta decay near expiry, moneyness sweeps captured for audit.
