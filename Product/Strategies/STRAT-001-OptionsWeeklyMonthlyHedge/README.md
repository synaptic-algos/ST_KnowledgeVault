...
- **[[../../Design/EPIC-007-STRAT-001-IMPLEMENTATION-PROPOSAL|EPIC-007 + STRAT-001 Implementation Proposal]]** - Comprehensive proposal covering domain model, framework adapters, backtest infrastructure, research pipeline, and deployment runbooks

**Supporting Architecture**:
- **[[../../Design/DATA-PIPELINE-ARCHITECTURE|Data Pipeline Architecture]]** - NSE options data infrastructure for backtesting
